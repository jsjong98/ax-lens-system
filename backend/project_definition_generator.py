...
Step A. 데이터 분석
  — 분류 결과(AI 수행 가능, AI+Human, 인간 수행 필요)의 분포를 파악합니다.
...
def generate_project_definition_fallback(
    ...
    return ProjectDefinition(
        ...
        overview=[
            f"{process_name} 프로세스의 L5 Task {total}개 중 AI 수행 가능 {ai_count}개, AI+Human {hybrid_count}개를 자동화 (인간 수행 필요 {human_count}개)",
