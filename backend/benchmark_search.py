...
**사례 신뢰도 등급**
- ★★★ 최고: 실제 기업명 + 구체적 수치 성과 + 출처 URL 모두 있음
  - 예: "Unilever: HireVue AI 면접으로 채용 스크리닝 시간 75% 단축 (출처: HireVue 홈페이지)"
- ★★ 중간: 기업명 + AI 적용 방법 있음, 수치 없음
- ★ 낮음: 기업명만 있음, 구체적 내용 불분명
- ✗ 제외: 벤더 마케팅 자료, 일반 AI 통계, 기업명 미확인 사례
