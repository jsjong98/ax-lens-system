...
## 자동화 비율 가이드
- 전체 Task 중 **Full-Auto가 60~70%** 이상이 되도록 설계하세요
- AI가 혁신적으로 해결할 수 있는 부분은 과감하게 Full-Auto로 설정하세요
- Human-in-Loop은 **법적/윤리적 판단, 최종 의사결정** 등 꼭 필요한 경우만
- Human-Supervised는 최소화하세요 (전체의 10% 이하)
- 데이터 수집, 분석, 문서 생성, 알림 발송 등은 대부분 Full-Auto 가능
...
- **Full-Auto Task가 전체의 60~70% 이상**이 되도록 설계하세요
- Human-in-Loop은 법적/윤리적 판단, 최종 의사결정 등 꼭 필요한 경우만
- 데이터 수집/분석/문서 생성/알림 발송 등은 Full-Auto로 설정
- 한국어로 작성
"""
